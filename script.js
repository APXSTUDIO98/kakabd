...
var giftOpened = document.getElementById('giftOpen');
...
function changeBackground() {
  setTimeout(function() {
    body.style.backgroundColor = 'rgb(129, 129, 129)'; 
    giftOpened.style.display = 'none';// New background color after gift opens
